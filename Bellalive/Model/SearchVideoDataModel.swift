...
struct SearchVideoDataModel : Codable {
        ...
        let code : Int?
        let data : [SearchVideoDataDatum]?
        let links : SearchVideoDataLink?
        let meta : SearchVideoDataMeta?
        let status : String?
        ...
        init(from decoder: Decoder) throws {
                ...
                data = try values.decodeIfPresent([SearchVideoDataDatum].self, forKey: .data)
                links = try values.decodeIfPresent(SearchVideoDataLink.self, forKey: .links)
                meta = try values.decodeIfPresent(SearchVideoDataMeta.self, forKey: .meta)
                status = try values.decodeIfPresent(String.self, forKey: .status)
        }

}

struct SearchVideoDataMeta : Codable {
...
struct SearchVideoDataLink : Codable {
...
struct SearchVideoDataDatum : Codable {
        ...
        init(from decoder: Decoder) throws {
                ...
                maxAudience = try values.decodeIfPresent(String.self, forKey: .maxAudience)
                newFollows = try values.decodeIfPresent(String.self, forKey: .newFollows)
                receivedPoints = try values.decodeIfPresent(Int.self, forKey: .receivedPoints)
                shareNo = try values.decodeIfPresent(String.self, forKey: .shareNo)
                ...
                user = try values.decodeIfPresent(SearchVideoDataUser.self, forKey: .user)
                userId = try values.decodeIfPresent(Int.self, forKey: .userId)
        }

}
struct SearchVideoDataUser : Codable {
