...
struct UpdateTokenModel : Codable {
        ...
        init(from decoder: Decoder) throws {
                ...
                data = try values.decodeIfPresent(UpdateTokenData.self, forKey: .data)
...
struct UpdateTokenData : Codable {
        ...
        let bio : String?
        let city : String?
        let country : UpdateTokenCountry?
        ...
        init(from decoder: Decoder) throws {
                ...
                country = try values.decodeIfPresent(UpdateTokenCountry.self, forKey: .country)
...
struct UpdateTokenCountry : Codable {
