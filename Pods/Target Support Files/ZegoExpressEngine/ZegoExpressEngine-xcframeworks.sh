...
install_xcframework "${PODS_ROOT}/ZegoExpressEngine/Video/iOS/ZegoExpressEngine.xcframework" "ZegoExpressEngine" "framework" "ios-arm64_armv7" "ios-x86_64-simulator"
